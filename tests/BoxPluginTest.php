 ...
 * @coversNothing
 */
final class BoxPluginTest extends TestCase
{
    private function instantiate(): DiagnosticsPluginInterface
    {
        return include dirname(__DIR__) . '/src/box.php';
    }

    public function testPluginName(): void
    {
        self::assertSame('box', $this->instantiate()->getName());
    }
